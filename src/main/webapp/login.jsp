												...
												<fieldset>
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															...
															<input id="loginEmail" name="email" class="form-control" type="text" placeholder="Username" /> <!--  class="form-control" -->
										...
										<div class="widget-main">
											...
											<form id="validationRegisterForm" method="post" action="#">
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="repeatPassword" name="repeatPassword" type="password" class="form-control" placeholder="Password Again" />
